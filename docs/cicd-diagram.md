...
> **Auth AWS**: ⚠️ OIDC propuesto — método a confirmar con el equipo AWS/company  
...
## 8. Alineación con DevSecOps company
...
| Gates seguridad | No mencionados | Job 1: Sonarcloud + Fluid Attacks + Semgrep/Bandit | Alineación con DevSecOps company |
