...
> **Auth AWS:** ⚠️ OIDC propuesto — pendiente confirmación con equipo AWS/IBK  
...
| Gates de seguridad | No mencionados | Job 1: Sonarcloud + Fluid Attacks + Semgrep/Bandit | Alineación DevSecOps IBK. |
