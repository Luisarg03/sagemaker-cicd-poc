...
def build_training_step(
    ...
    tuner = HyperparameterTuner(
        ...
        metric_definitions=[
            {"Name": "validation:auc", "Regex": "validation_1-auc:([0-9\\.]+)"}
        ],
    ...
    inputs = {
        ...
        "val": TrainingInput(
            s3_data=Join(on="/", values=[s3_dataset, "val.csv"]), content_type="csv"
        ),
    }
...
def main():
    ...
    training_max_parallel_jobs = ParameterInteger(
        name="TrainingMaxParallelJobs", default_value=1
    )
